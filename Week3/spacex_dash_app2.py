...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(value = 'Select Launch Site',id='site-dropdown', 
...
def get_pie_chart(entered_site):
    ...
    # df = spacex_df.groupby('Launch Site').count().reset_index().rename(columns={'class':'Succesful Launches'})
    # filtered_df['Success Rate']=filtered_df['Success Rate']*100
    if entered_site == 'ALL':
        ...
        filtered_df = spacex_df[(spacex_df['Launch Site'] == entered_site)].groupby(['Launch Site', 'class']).size().reset_index(name='Counts')
